<x-layout>
    ...
    <main class="flex h-full flex-col gap-4">
        ...
        <section class="h-full overflow-y-scroll rounded-xl bg-white shadow-md">
            <div class="p-4">
                <div
                    class="sticky top-0 z-10 grid grid-cols-[4%_30%_25%_auto_15%] items-center border-b border-gray-400 bg-[#e4e4e4] shadow">
                ...
                @foreach ($transaksiPeminjaman as $transaction)
                    <div class="grid grid-cols-[4%_30%_25%_auto_15%] border-b border-gray-400">
