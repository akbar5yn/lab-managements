    ...
    <main class="flex h-full flex-col gap-4">
        ...
        <section class="h-full overflow-y-scroll rounded-xl bg-white shadow-md">
            <div class="h-full">
                ...
                @elseif ($transaksiPeminjaman->isNotEmpty())
                                        ...
                                        <form action="{{ route('post.riwayat.transaksi.alat') }}" method="POST">
                                            ...
                                            <div class="flex flex-col gap-6 rounded-lg border p-4">
                                                ...
                                                <div
                                                    ...
                                                    <label for="tgl_pengembalian font-semibold">Tanggal
                                                        Pengembalian</label>
                                                ...
                                                <div x-data="{ isOpen: false, status: 'normal' }"
                                                    ...
                                                    <div x-cloak x-show="isOpen" @click.outside="isOpen = false"
                                                        ...
                                                        <div class="w-full py-1" role="none">
                                                            ...
                                                            <!-- Button Rusak -->
                                                            <button type="button"
                                                                @click="status = 'rusak'; isOpen = false"
                                                                class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
                                                                role="menuitem">
                                                                Rusak
                                                            </button>
